...
<div id="app" style="display:block; width:100%; height:100%; position:relative;">
  ...
  <div class="hud" role="main" aria-label="Drone HUD Interface">
    ...
    <aside class="side-panel panel-right" aria-label="Right instrument panel">
      ...
      <!-- <div class="glass-card">
        ...
        <div class="threat-row">
          <span class="threat-label">TGT-ALPHA</span>
          <div class="threat-bar-wrap"><div class="threat-bar-fill threat-high"></div></div>
          <span class="card-value card-value-sm card-red">HIGH</span>
        </div>
        <div class="threat-row">
          <span class="threat-label">TGT-BRAVO</span>
          <div class="threat-bar-wrap"><div class="threat-bar-fill threat-med"></div></div>
          <span class="card-value card-value-sm card-orange">MED</span>
        </div>
        <div class="card-row card-row-top">
          <span class="card-key">LOCK STATUS</span>
          <span class="card-value card-red">TGT-A LOCKED</span>
        </div>
      </div>
      ...
      <!-- <div class="glass-card">
        ...
        <div class="card-row"><span class="card-key">WIND</span><span class="card-value">8km/h NE</span></div>
        <div class="card-row"><span class="card-key">TEMP</span><span class="card-value">28°C</span></div>
        <div class="card-row"><span class="card-key">VISIBILITY</span><span class="card-value card-green">CLEAR</span></div>
        <div class="card-row"><span class="card-key">PRESSURE</span><span class="card-value">1013 hPa</span></div>
      </div> -->
    ...
    <div class="center-zone" id="centerZone" aria-label="Targeting reticle">
      ...
      <div class="reticle-ring reticle-ring-2" aria-hidden="true"></div>
      <div class="reticle-ring reticle-ring-3" aria-hidden="true"></div>
